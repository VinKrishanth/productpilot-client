...
const Sidebar = ({ className = '', isOpen = false, onClose = () => {} }) => {
  ...
  const navigation = [
    ...
    { name: 'Orders', icon: ShoppingCart, href: '/customer/order-history' },
    { name: 'Profile', icon: UserPenIcon, href: '/customer/settings' },
    { name: 'Address', icon: MapPinHouse, href: '/customer/settings/billing-address' },
    { name: 'Password', icon: KeySquare, href: '/customer/settings/change-password' },
  ];
